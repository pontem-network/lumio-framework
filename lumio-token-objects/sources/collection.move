...
module lumio_token_objects::collection {
    use std::error;
    use std::features;
    ...
    friend lumio_token_objects::token;
    ...
    entry fun test_create_and_transfer_as_owner(creator: &signer, trader: &signer, lumio_framework: &signer) {
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = lumio_token_objects::collection)]
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x20009, location = lumio_token_objects::collection)]
