/// `PropertyMap` provides generic metadata support for `LumioToken`. It is a specialization of
...
module lumio_token_objects::property_map {
    use std::bcs;
    use std::error;
    ...
    use lumio_framework::object::{Self, ConstructorRef, Object, ExtendRef, ObjectCore};
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x10001, location = lumio_std::from_bcs)]
