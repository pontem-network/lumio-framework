...
module lumio_framework::chain_status {
    ...
    public(friend) fun set_genesis_end(lumio_framework: &signer) {
        system_addresses::assert_lumio_framework(lumio_framework);
        move_to(lumio_framework, GenesisEndMarker {});
    }

    #[view]
    /// Helper function to determine if Lumio is in genesis state.
    public fun is_genesis(): bool {
        !exists<GenesisEndMarker>(@lumio_framework)
    }
