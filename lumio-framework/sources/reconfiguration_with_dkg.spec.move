spec lumio_framework::reconfiguration_with_dkg {
    spec module {
        pragma verify = true;
    }
    ...
    spec try_start() {
        ...
        requires exists<reconfiguration::Configuration>(@lumio_framework);
    ...
    spec schema FinishRequirement {
        ...
        framework: signer;
        requires signer::address_of(framework) == @lumio_framework;
        requires chain_status::is_operating();
