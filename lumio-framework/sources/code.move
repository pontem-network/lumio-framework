...
module lumio_framework::code {
    ...
    friend lumio_framework::object_code_deployment;
    ...
    fun initialize(lumio_framework: &signer, package_owner: &signer, metadata: PackageMetadata)
