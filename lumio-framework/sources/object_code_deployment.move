...
module lumio_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::signer;
    ...
    use lumio_framework::code::PackageRegistry;
    use lumio_framework::event;
    use lumio_framework::object;
    use lumio_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"lumio_framework::object_code_deployment";
