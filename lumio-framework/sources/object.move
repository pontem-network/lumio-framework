...
module lumio_framework::object {
    ...
    fun test_correct_auid() {
        let auid1 = lumio_framework::transaction_context::generate_auid_address();
        let bytes = lumio_framework::transaction_context::get_transaction_hash();
        ...
        let auid2 = lumio_framework::from_bcs::to_address(std::hash::sha3_256(bytes));
