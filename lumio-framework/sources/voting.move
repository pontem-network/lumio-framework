...
module lumio_framework::voting {
    ...
    public fun create_proposal_with_empty_execution_hash_should_fail_generic(
        ...
        account::create_account_for_test(@lumio_framework);
        let governance_address = signer::address_of(governance);
    ...
    #[test(lumio_framework = @lumio_framework, governance = @0x123)]
    public entry fun test_voting_passed(lumio_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_generic(lumio_framework, governance, false, false);
    }

    #[test(lumio_framework = @lumio_framework, governance = @0x123)]
    public entry fun test_voting_passed_multi_step(lumio_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_generic(lumio_framework, governance, true, true);
    }
    ...
    public entry fun test_voting_passed_multi_step_cannot_use_single_step_resolve_function(
        ...
        test_voting_passed_generic(lumio_framework, governance, true, false);
    }
    ...
    public entry fun test_voting_passed_single_step_can_use_generic_function(
        ...
        test_voting_passed_generic(lumio_framework, governance, false, true);
    }
    ...
    public entry fun test_cannot_resolve_twice(lumio_framework: &signer, governance: &signer) acquires VotingForum {
        test_cannot_resolve_twice_generic(lumio_framework, governance, false);
    }
    ...
    public entry fun test_cannot_resolve_twice_multi_step(
        ...
        test_cannot_resolve_twice_generic(lumio_framework, governance, true);
    }
    ...
    #[test(lumio_framework = @lumio_framework, governance = @0x123)]
    public entry fun test_voting_passed_early(lumio_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_early_generic(lumio_framework, governance, false);
    }
    ...
    public entry fun test_voting_passed_early_multi_step(
        ...
        test_voting_passed_early_generic(lumio_framework, governance, true);
    }
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail(
        ...
        test_voting_passed_early_in_same_tx_should_fail_generic(lumio_framework, governance, false);
    }
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail_multi_step(
        ...
        test_voting_passed_early_in_same_tx_should_fail_generic(lumio_framework, governance, true);
    }
    ...
    public entry fun test_voting_failed(lumio_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_generic(lumio_framework, governance, false);
    }

    #[test(lumio_framework = @lumio_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002, location = Self)]
    public entry fun test_voting_failed_multi_step(lumio_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_generic(lumio_framework, governance, true);
    }
    ...
    #[test(lumio_framework = @lumio_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002, location = Self)]
    public entry fun test_voting_failed_early(lumio_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_early_generic(lumio_framework, governance, true);
    }
    ...
    public entry fun test_voting_failed_early_multi_step(
        ...
        test_voting_failed_early_generic(lumio_framework, governance, false);
    }
    ...
    public entry fun test_cannot_set_min_threshold_higher_than_early_resolution(
        ...
        test_cannot_set_min_threshold_higher_than_early_resolution_generic(lumio_framework, governance, false);
    }
    ...
    public entry fun test_cannot_set_min_threshold_higher_than_early_resolution_multi_step(
        ...
        test_cannot_set_min_threshold_higher_than_early_resolution_generic(lumio_framework, governance, true);
    }

    #[test(lumio_framework = @lumio_framework, governance = @0x123)]
    public entry fun test_replace_execution_hash(lumio_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@lumio_framework);
        timestamp::set_time_has_started_for_testing(lumio_framework);
