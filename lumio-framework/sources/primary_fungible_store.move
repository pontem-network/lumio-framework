...
module lumio_framework::primary_fungible_store {
    use lumio_framework::dispatchable_fungible_asset;
    use lumio_framework::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata, MintRef, TransferRef, BurnRef};
    use lumio_framework::object::{Self, Object, ConstructorRef, DeriveRef};
    ...
    public fun grant_apt_permission(
        ...
        fungible_asset::grant_permission_by_address(
            master,
            permissioned,
            object::create_user_derived_object_address(signer::address_of(permissioned), @lumio_fungible_asset),
            amount
        );
    }
