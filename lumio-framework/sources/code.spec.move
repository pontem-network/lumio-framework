spec lumio_framework::code {
    ...
    /// Enforcement: The Lumio upgrade native functions have been manually audited.
    ///
    /// No.: 2
    ...
    spec initialize(lumio_framework: &signer, package_owner: &signer, metadata: PackageMetadata) {
