spec lumio_framework::staking_proxy {
    /// <high-level-req>
    /// No.: 1
    ...
    /// Enforcement: Enforced via [https://github.com/lumio-labs/lumio-core/blob/main/lumio-move/framework/lumio-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
    ...
    spec schema SetStakingContractOperator {
        ...
        use lumio_framework::staking_contract::{Store};
