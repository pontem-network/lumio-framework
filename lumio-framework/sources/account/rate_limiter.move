module lumio_framework::rate_limiter {
    ...
    fun test_initialize_bucket(lumio_framework: &signer) {
    ...
    #[test(lumio_framework = @0x1)]
    fun test_request_success(lumio_framework: &signer) {
        timestamp::set_time_has_started_for_testing(lumio_framework);
    ...
    #[test(lumio_framework = @0x1)]
    fun test_request_failure(lumio_framework: &signer) {
        timestamp::set_time_has_started_for_testing(lumio_framework);
        let bucket = initialize(10, 30);
    ...
    #[test(lumio_framework = @0x1)]
    fun test_refill(lumio_framework: &signer) {
        timestamp::set_time_has_started_for_testing(lumio_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(lumio_framework= @0x1)]
    fun test_fractional_accumulation(lumio_framework: &signer) {
        timestamp::set_time_has_started_for_testing(lumio_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(lumio_framework= @0x1)]
    fun test_multiple_refills(lumio_framework: &signer) {
        timestamp::set_time_has_started_for_testing(lumio_framework);
        let bucket = initialize(10, 60);
