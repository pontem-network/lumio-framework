...
module lumio_framework::optional_aggregator {
    use std::error;
    ...
    #[test(account = @lumio_framework)]
    #[expected_failure(abort_code = 0x020001, location = lumio_framework::aggregator)]
    ...
    #[test(account = @lumio_framework)]
    #[expected_failure(abort_code = 0x020002, location = lumio_framework::aggregator)]
