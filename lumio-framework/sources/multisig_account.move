...
module lumio_framework::multisig_account {
    use lumio_framework::account::{Self, SignerCapability, new_event_handle, create_resource_address};
    ...
    use lumio_framework::timestamp::now_seconds;
    ...
    /// account.
    const DOMAIN_SEPARATOR: vector<u8> = b"lumio_framework::multisig_account";
    ...
    #[test_only]
    use lumio_framework::coin::{destroy_mint_cap, destroy_burn_cap};
    ...
    fun setup() {
        ...
        let (burn, mint) = lumio_coin::initialize_for_test(framework_signer);
