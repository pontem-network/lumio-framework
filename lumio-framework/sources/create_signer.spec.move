spec lumio_framework::create_signer {
    use std::signer;

    /// <high-level-req>
    /// No.: 1
    /// Requirement: Obtaining a signer for an arbitrary account should only be available within the Lumio Framework.
    ...
    /// Enforcement: Enforced by the [https://github.com/lumio-labs/lumio-core/blob/main/third_party/move/move-vm/types/src/values/values_impl.rs#L1129](move vm).
    ///
    /// No.: 3
