...
module 0xcafe::deflation_token {
    use lumio_framework::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    use lumio_framework::dispatchable_fungible_asset;
    use lumio_framework::object::{ConstructorRef, Object};
    ...
    #[test_only]
    use lumio_framework::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status=4037, location=lumio_framework::dispatchable_fungible_asset)]
