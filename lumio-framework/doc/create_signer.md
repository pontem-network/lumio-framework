...
Provides a common place for exporting <code><a href="create_signer.md#0x1_create_signer">create_signer</a></code> across the Lumio Framework.

To use create_signer, add the module below, such that:
<code><b>friend</b> lumio_framework::friend_wants_create_signer</code>
...
Note, that this is only available within the Lumio Framework.
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="create_signer.md#0x1_create_signer">create_signer</a>(addr: <b>address</b>): <a href="../../lumio-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>native</b> <b>fun</b> <a href="create_signer.md#0x1_create_signer">create_signer</a>(addr: <b>address</b>): <a href="../../lumio-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>;
</code></pre>
...
<tr>
<td>1</td>
<td>Obtaining a signer for an arbitrary account should only be available within the Lumio Framework.</td>
<td>Critical</td>
...
<td>Enforced by the <a href="https://github.com/lumio-labs/lumio-core/blob/main/third_party/move/move-vm/types/src/values/values_impl.rs#L1129">move vm</a>.</td>
</tr>
...
<b>ensures</b> [abstract] <a href="../../lumio-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(result) == addr;
...
<pre><code><b>fun</b> <a href="create_signer.md#0x1_create_signer_spec_create_signer">spec_create_signer</a>(addr: <b>address</b>): <a href="../../lumio-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>;
</code></pre>
