...
<pre><code><b>fun</b> <a href="transaction_validation.md#0x1_transaction_validation_prologue_common">prologue_common</a>(
    ...
    <b>assert</b>!(
        <a href="coin.md#0x1_coin_is_account_registered">coin::is_account_registered</a>&lt;NativeCoin&gt;(gas_payer),
    ...
    <b>let</b> balance = <a href="coin.md#0x1_coin_balance">coin::balance</a>&lt;NativeCoin&gt;(gas_payer);
...
<pre><code><b>fun</b> <a href="transaction_validation.md#0x1_transaction_validation_epilogue_gas_payer">epilogue_gas_payer</a>(
    ...
    <b>assert</b>!(
        <a href="coin.md#0x1_coin_balance">coin::balance</a>&lt;NativeCoin&gt;(gas_payer) &gt;= transaction_fee_amount,
...
<pre><code><b>schema</b> <a href="transaction_validation.md#0x1_transaction_validation_PrologueCommonAbortsIf">PrologueCommonAbortsIf</a> {
    ...
    <b>aborts_if</b> !(txn_sequence_number == <b>global</b>&lt;Account&gt;(transaction_sender).sequence_number);
    <b>aborts_if</b> !<b>exists</b>&lt;CoinStore&lt;NativeCoin&gt;&gt;(gas_payer);
    <b>aborts_if</b> !(<b>global</b>&lt;CoinStore&lt;NativeCoin&gt;&gt;(gas_payer).<a href="coin.md#0x1_coin">coin</a>.value &gt;= max_transaction_fee);
}
</code></pre>
...
<code>NativeCoinCapabilities</code> and <code>CoinInfo</code> should exists.
...
<pre><code><b>schema</b> <a href="transaction_validation.md#0x1_transaction_validation_EpilogueGasPayerAbortsIf">EpilogueGasPayerAbortsIf</a> {
    ...
    <b>let</b> addr = <a href="../../../../../../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="account.md#0x1_account">account</a>);
    <b>aborts_if</b> !<b>exists</b>&lt;CoinStore&lt;NativeCoin&gt;&gt;(gas_payer);
    <b>aborts_if</b> !(<b>global</b>&lt;CoinStore&lt;NativeCoin&gt;&gt;(gas_payer).<a href="coin.md#0x1_coin">coin</a>.value &gt;= transaction_fee_amount);
    ...
    <b>let</b> pre_balance = <b>global</b>&lt;<a href="coin.md#0x1_coin_CoinStore">coin::CoinStore</a>&lt;NativeCoin&gt;&gt;(gas_payer).<a href="coin.md#0x1_coin">coin</a>.value;
    <b>let</b> <b>post</b> balance = <b>global</b>&lt;<a href="coin.md#0x1_coin_CoinStore">coin::CoinStore</a>&lt;NativeCoin&gt;&gt;(gas_payer).<a href="coin.md#0x1_coin">coin</a>.value;
    ...
    <b>let</b> apt_addr = <a href="../../../../../../../aptos-stdlib/doc/type_info.md#0x1_type_info_type_of">type_info::type_of</a>&lt;NativeCoin&gt;().account_address;
    <b>let</b> maybe_apt_supply = <b>global</b>&lt;CoinInfo&lt;NativeCoin&gt;&gt;(apt_addr).supply;
    ...
    <b>aborts_if</b> <b>if</b> (<a href="../../../../../../../aptos-stdlib/../move-stdlib/doc/features.md#0x1_features_spec_is_enabled">features::spec_is_enabled</a>(<a href="../../../../../../../aptos-stdlib/../move-stdlib/doc/features.md#0x1_features_COLLECT_AND_DISTRIBUTE_GAS_FEES">features::COLLECT_AND_DISTRIBUTE_GAS_FEES</a>)) {
        !<b>exists</b>&lt;CollectedFeesPerBlock&gt;(@aptos_framework)
            ...
            ( // `<b>exists</b>&lt;CoinStore&lt;NativeCoin&gt;&gt;(addr)` checked above.
        ...
        // Sufficiency of funds is checked above.
        !<b>exists</b>&lt;NativeCoinCapabilities&gt;(@aptos_framework) ||
            // Existence of APT's CoinInfo
            transaction_fee_amount &gt; 0 && !<b>exists</b>&lt;CoinInfo&lt;NativeCoin&gt;&gt;(aptos_addr) ||
    ...
    <b>let</b> <b>post</b> post_maybe_apt_supply = <b>global</b>&lt;CoinInfo&lt;NativeCoin&gt;&gt;(apt_addr).supply;
