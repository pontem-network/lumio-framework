...
<pre><code><b>fun</b> <a href="block.md#0x1_block_block_prologue">block_prologue</a>(
    ...
    //     proposer_index = <a href="../../../../../../../aptos-stdlib/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(stake::get_validator_index(proposer));
    // };
    ...
    <b>if</b> (<a href="../../../../../../../aptos-stdlib/../move-stdlib/doc/features.md#0x1_features_collect_and_distribute_gas_fees">features::collect_and_distribute_gas_fees</a>()) {
        // TODO: change comment explaining the actual behaviour for the l2
    ...
    <a href="state_storage.md#0x1_state_storage_on_new_block">state_storage::on_new_block</a>(epoch);
