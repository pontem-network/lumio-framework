spec aptos_framework::native_coin {
    spec module {
        pragma verify = true;
    ...
    spec initialize {
        ...
        ensures exists<coin::CoinInfo<NativeCoin>>(addr);
    }
    ...
    spec schema ExistsNativeCoin {
        requires exists<coin::CoinInfo<NativeCoin>>(@aptos_framework);
    }
