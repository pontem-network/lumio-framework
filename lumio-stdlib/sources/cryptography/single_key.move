...
module lumio_std::single_key {
    use lumio_std::bcs_stream::{Self, deserialize_u8};
    use lumio_std::ed25519;
    use lumio_std::keyless;
    use lumio_std::secp256k1;
    use lumio_std::secp256r1;
    use lumio_std::bcs;
    use lumio_std::federated_keyless;
    use std::error;
    use std::hash;
    ...
    /// The identifier of the Single Key signature scheme, which is used when deriving Lumio authentication keys by hashing
