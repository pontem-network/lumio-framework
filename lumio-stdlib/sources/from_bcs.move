...
/// a general conversion back-and-force is needed, consider the `lumio_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
...
module lumio_std::from_bcs {
    ...
    friend lumio_std::any;
    friend lumio_std::copyable_any;
