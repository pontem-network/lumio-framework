module lumio_std::smart_vector {
    use std::error;
    use lumio_std::big_vector::{Self, BigVector};
    use lumio_std::math64::max;
    use lumio_std::type_info::size_of_val;
    ...
    public inline fun map_ref<T1, T2: store>(
        ...
        let result = lumio_std::smart_vector::new<T2>();
    ...
    public inline fun filter<T: store + drop>(
        ...
        let result = lumio_std::smart_vector::new<T>();
        self.for_each(|elem| {
    ...
    public inline fun zip_map<T1: store, T2: store, NewT: store>(
        ...
        let result = lumio_std::smart_vector::new<NewT>();
